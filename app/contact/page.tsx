  ...
  return (
    <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black mt-15">
      ...
      <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
        Login to musics art  if you can because we don&apos;t have a login flow
        yet
      </p>
      ...
      <form className="my-5" onSubmit={handleSubmit}>
        ...
        <div className="my-8 h-px w-full bg--to-r from-transparent via-neutral-300 to-transparent dark:via-neutral-700" />
